...
export default function Banner() {
  return (
    <section className=" lg:py-20 py-5 bg-green-50 overflow-hidden">
      <div className="container grid lg:grid-cols-2 items-center lg:gap-20 space-y-16 lg:space-y-0 justify-center">
        {/* img secion  */}
        ...
        {/* text section  */}
        <div className="lg:space-y-16 space-y-10 capitalize lg:text-xl text-base order-first lg:order-last">
          <h2 className="lg:text-[80px] text-4xl font-semibold text-balance leading-[90px]">
